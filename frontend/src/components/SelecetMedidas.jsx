...
export default function SelectMedidas() {
  ...
  return (
    <Box sx={{ minWidth: 120 }}>
      ...
      <Box
        sx={{
          position: 'relative',
          height: medidas ? 100 : 0, // Ajusta la altura dinámicamente
          width: 400,
          marginBottom: 2,
